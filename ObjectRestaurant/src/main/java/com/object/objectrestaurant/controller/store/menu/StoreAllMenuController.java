...
public class StoreAllMenuController {
	/*
	 ...
	 */
	@GetMapping("/menu")
	public String getStoreMenu(@PathVariable(name = "storeId")String storeId, 
			@RequestParam(required = false) String select) {
		if(select == null)
			return "스토어 '"+storeId+"'의 메뉴 '전부' 가져오기";
		
		return "스토어 '"+storeId+"'의 메뉴의 '전부'의 " +select+ " 가져오기";
	}
	 ...
	 */
	@DeleteMapping("/menu")
	public String deleteStoreAllMenu(@PathVariable(name = "storeId")String storeId) {
		return "스토어 '"+storeId+"'의 메뉴 '전부' 삭제";
	}
